(() => {
    ...
    function initSliders() {
        if (document.querySelector(".filter-catalogue__slider--pillows")) new swiper_core_Swiper(".filter-catalogue__slider--pillows", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.5,
        ...
        if (document.querySelector(".filter-catalogue__slider--mask")) new swiper_core_Swiper(".filter-catalogue__slider--mask", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".filter-catalogue__slider--mattress")) new swiper_core_Swiper(".filter-catalogue__slider--mattress", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".filter-catalogue__slider--blanket")) new swiper_core_Swiper(".filter-catalogue__slider--blanket", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".blog__slider")) new swiper_core_Swiper(".blog__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".navigations__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".navigations__button--left",
                nextEl: ".navigations__button--right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
