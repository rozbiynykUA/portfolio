 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function documentActions(e) {
            ...
            const type = e.type;
            if (type === `click`) {
                if (targetElement.closest(`.icon-menu`)) html.classList.toggle(`menu-open`);
                if (targetElement.closest(`.menu__link`) && html.classList.contains(`menu-open`)) html.classList.remove(`menu-open`);
            }
        }
        window["FLS"] = true;
        addLoadedClass();
