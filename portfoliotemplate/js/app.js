(() => {
    ...
    function initSliders() {
        if (document.querySelector(".team__slider")) new swiper_core_Swiper(".team__slider", {
            ...
            navigation: {
                prevEl: ".controls__swiper-button-prev",
                nextEl: ".controls__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerGroup: 1,
        ...
        if (document.querySelector(".testimonials-about-agency__items")) new swiper_core_Swiper(".testimonials-about-agency__items", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".works-portfolio-agency-one__slider")) new swiper_core_Swiper(".works-portfolio-agency-one__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            pagination: {
                el: ".works-portfolio-agency-one__swiper-pagination",
                clickable: true
            },
            breakpoints: {
                320: {
