 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-team")) new swiper_core_Swiper(".slider-team", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 1e3,
                navigation: {
                    prevEl: ".navigation-slider__button--team-prev",
                    nextEl: ".navigation-slider__button--team-next"
                },
                on: {}
            });
            if (document.querySelector(".about__slider")) new swiper_core_Swiper(".about__slider", {
                ...
                speed: 1200,
                navigation: {
                    prevEl: ".navigation-slider__button--about-prev",
                    nextEl: ".navigation-slider__button--about-next"
                },
                on: {}
            });
            if (document.querySelector(".press__slider")) new swiper_core_Swiper(".press__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 2.5,
            ...
            if (document.querySelector(".social-page__slider")) new swiper_core_Swiper(".social-page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 0,
                ...
                speed: 1e3,
                navigation: {
                    prevEl: ".navigation-slider__button--social-prev",
                    nextEl: ".navigation-slider__button--social-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
